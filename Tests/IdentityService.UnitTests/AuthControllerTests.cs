...
public class AuthControllerTests
{
    ...
    var grpcClient = new Mock<Subscription.SubscriptionClient>(MockBehavior.Loose, (ChannelBase)null!);
    var controller = new AuthController(userMgr.Object, signIn.Object, config, logger, grpcClient.Object);

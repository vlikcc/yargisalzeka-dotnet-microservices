...
import { CaseAnalysisResponse, ScoredDecision, KeywordExtractionResponse } from './aiService';
...
export interface SearchResponse { analysis: CaseAnalysisResponse; keywords?: KeywordExtractionResponse; searchId: string; scoredDecisions?: ScoredDecision[]; } 
